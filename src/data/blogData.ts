...
export const BLOG_ARTICLES: BlogArticle[] = [
  {
    id: "1",
    title: "كيف تكتب سيرة ذاتية احترافية تجذب الانتباه؟",
    titleEn: "How to Write a Professional CV that Commands Attention?",
    slug: "how-to-write-professional-cv",
    summary: "تعرف على الخطوات العملية والنصائح الذهبية لكتابة سيرة ذاتية متكاملة تزيد من فرص قبولك في المقابلات الشخصية وتلفت انتباه مسؤولي التوظيف.",
    summaryEn: "Discover the step-by-step practical advice for writing an outstanding resume that doubles your call-back rates and highlights your ultimate professional capabilities.",
    category: "نصائح السيرة الذاتية",
...
Even a minor spelling error reflects carelessness. Validate the folder multiple times, or export it in a cleanly formatted, flat PDF layout.`
  ...
  {
    id: "2",
    title: "ما هو نظام ATS (نظام تتبع المتقدمين) وكيف تتجاوزه بنجاح؟",
    titleEn: "What is ATS (Applicant Tracking System) and How to Beat It?",
    slug: "what-is-ats-system",
    summary: "افهم كيف تفكر برامج الفحص الآلي للشركات وكيف تضمن ألا تُرفض سيرتك الذاتية آليًا قبل أن يراها العنصر البشري.",
    summaryEn: "Demystify Applicant Tracking Systems. Learn how hiring tech scans your resume, what breaks parsing algorithms, and how to optimize your resume naturally.",
    category: "التكنولوجيا والتوظيف",
    categoryEn: "Tech & Hiring",
    readTime: "4 دقائق",
    date: "2026-05-18",
...
Always export files as selectable, digitally generated PDFs or Microsoft Word (.docx) files. Avoid using scanned photocopies or flat image formats (PNG/JPG), since algorithms will fail to recognize the text inside.`
  ...
  {
    id: "3",
    title: "أفضل مهارات تكتبها في السيرة الذاتية (وكيف تعرضها باحترافية؟)",
    titleEn: "Top Skills to Feature in a CV (And How to Showcase Them)",
    slug: "top-skills-to-include-in-cv",
    summary: "تنقسم المهارات إلى صلبة ملموسة وناعمة اجتماعية. تَعَلَم الأسماء الأكثر طلبًا في سوق العمل الخليجي والعربي اليوم.",
    summaryEn: "Explore the distinction between core technical skills and strategic human relations, and learn how to present them to reflect direct workspace mastery.",
    category: "المهارات المتكاملة",
    categoryEn: "Workspace Skills",
    readTime: "3 دقائق",
    date: "2026-05-15",
...
- **GenAI Prompt Strategy:** Adapting AI accelerators to double corporate copy, coding, and workflow pipelines.`
  ...
  {
    id: "4",
    title: "كيف تكتب وصفًا وظيفيًا احترافيًا يجذب أفضل الكفاءات؟",
    titleEn: "How to Produce a Magnetizing Job Description for Top Talents?",
    slug: "how-to-write-job-description",
    summary: "تعلم من خبراء التوظيف المنهجية الصحيحة لبناء بطاقات التوصيف المهني التي تضمن تصفية المتقدمين ودخول الكوادر المناسبة فقط.",
    summaryEn: "Learn how to structure clear job specifications. Includes a detailed step-by-step framework to outline responsibilities, expectations, and benefits to attract the perfect fit.",
    category: "دليل الشركات التوظيفي",
    categoryEn: "Employer Guide",
    readTime: "4 دقائق",
    date: "2026-05-12",
...
Disclosing a wage range or high-value benefits (e.g., comprehensive medical care, annual tickets, performance bonuses) drives up application conversions from top-tier talent by over 40%.`
  ...
  {
    id: "5",
    title: "ما الفرق الحقيقي بين السيرة الذاتية الـ CV والـ Resume؟",
    titleEn: "What is the Real Distinction Between a CV and a Resume?",
    slug: "difference-between-cv-and-resume",
    summary: "هل يطلب منك صاحب العمل CV وتقوم بتقديم Resume؟ اعرف الفروق الأساسية في الطول والمحتوى والاستخدام الجغرافي المعترف به.",
    summaryEn: "Understand the clear architectural disparities between a Curriculam Vitae (CV) and a traditional Resume. Detailed context about length, region, and purpose.",
    category: "ثقافة التوظيف",
    categoryEn: "Career Advice",
    readTime: "3 دقائق",
    date: "2026-05-08",
...
| **التركيز** | كافة الإنجازات التعليمية والمهنية | الإنجازات والمهارات التي تخدم الشاغر فقط |
| **ميدان الاستخدام** | أكاديمي، بحثي، جامعات وطبي | وظائف القطاع الخاص، التقنية والصناعات |
...
| **Oversight Focus** | Lifelong academic & job trajectory | Matching specific vacancy requirements |
